                    ...
                    <input {...getInputProps()} />
                    {
                        newPost.photo?(
                            <div className="flex flex-row relative">
                                <Image height={96} width={96} alt="preview" src={URL.createObjectURL(newPost.photo)}/>
                            ...
                            <button className="flex flex-row justify-center items-center bg-zinc-500 rounded-md p-1 gap-2">
